...
const ProfileSideBar = () => {
  ...
  return (
    <div className="">
      <div className="p-4 bg-primary text-white bg-opacity-40 w-fit md:hidden fixed right-5 bottom-5" 
      ...
      <div className={` transition-all flex-col gap-3 md:w-[200px] z-[300]
       text-white flex md:translate-x-[0] items-start md:p-0 px-5 md:bg-transparent
        bg-slate-700 justify-center md:relative fixed top-0 bottom-0 left-0 w-2/3 ${isShown ? 'translate-x-0' : '-translate-x-full'}`}
        >
